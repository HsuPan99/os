      ...
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block bg-register-image">
            <img src="{{asset('frontend/frontendimg/c1.png')}}"></div>
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" method="POST" action="" enctype="multipart/form-data">
                 <div class="form-group">
                  <input type="file" class="form-control-file" id="exampleInputEmail" placeholder="Profile" name="user_profile">
                ...
                <div class="form-group">
                  <textarea class="form-control" placeholder="Address" name="user_address">
